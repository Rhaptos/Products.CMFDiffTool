"""
CangeSet.py - Zope object representing the differences between objects
...
class ChangeSet(SkinnedFolder, DefaultDublinCoreImpl):
    ...
    security.declarePublic('getDiffByField')
    def getDiffByField(self, fieldName):
        """Returns the IDifference instance with the given field name."""

        for id in self._diffs:
            if id.field == fieldName:
                return id
